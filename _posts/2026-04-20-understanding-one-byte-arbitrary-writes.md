...
![Gambar 1]({{ site.baseurl }}/assets/img/onebytewrite/1.png)
dan juga ini hasil analisis basic security nya
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/2.png)
...
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/3.png)
setelah dapat alamat nya langsung coba di gdb untuk membuktikan nya
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/4.png)
...
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/5.png)
dan mari kita coba, dan akhirnya mengalami segfault seperti ini
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/6.png)
...
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/7.png)
...
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/8.png)
...
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/9.png)
shingga opcode nya berubah dari `E8 13 FD FF FF` ke ----> `E8 D3 FD FF FF`
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/10.png)
...
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/12.png)
ini alur eksekusi nya
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/13.png)
...
```
![Gambar 2]({{ site.baseurl }}/assets/img/onebytewrite/16.png)
